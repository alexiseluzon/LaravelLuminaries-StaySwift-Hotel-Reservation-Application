                    ...
                    <div class="modal-content">
                        <div class="modal-body">
                            <form name="updateRoomForm" id="updateRoomForm">
                                ...
                                <div class="row g-0 mt-3">
                                    <div class="col-12">
                                        <label class="form-label">Room's Photo:</label>
                                ...
                                <div class="row g-0 mt-3">
                                    <div class="col-4">
                                        ...
                                        <select class="form-select shadow-sm rounded-0" aria-label="Default select example" id="roomStatus" name="roomStatus">
...
<?php /**PATH C:\xampp\htdocs\LaravelLuminaries-StaySwift-Hotel-Reservation-Application\resources\views/admin/room.blade.php ENDPATH**/ ?>
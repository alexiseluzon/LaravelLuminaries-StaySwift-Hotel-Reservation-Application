...
<head>
    ...
    <title>StaySwift — Administrator Login</title>
    <style>
...
<body>
    ...
    <div class="card">
        ...
        <span class="brand-sub">Restricted access</span>
        ...
        <form name="adminLoginForm" id="adminLoginForm">
            ...
            <div class="input-wrap">
                ...
                <input type="email" name="adminEmail" id="adminEmail" placeholder="admin@email.com" required>
            </div>

            <div class="input-wrap">
                <label for="adminPassword">Password</label>
                <input type="password" name="adminPassword" id="adminPassword" placeholder="Your password" required>
            </div>

            <label class="show-password">
                <input type="checkbox" onclick="seePasswordAdminLogin()">
...
</html><?php /**PATH C:\xampp\htdocs\LaravelLuminaries-StaySwift-Hotel-Reservation-Application\resources\views/adminLogin.blade.php ENDPATH**/ ?>
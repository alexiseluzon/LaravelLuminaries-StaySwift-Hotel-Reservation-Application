            ...
            <nav class="bg-white border-b border-gray-100">
                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('borrowed-items.index')" :active="route().current('borrowed-items.index')">
                                    <font-awesome-icon icon="handshake" class="h-6 w-6 mr-2 text-gray-600" />
                                    Borrowed Items
                                </NavLink>
                            </div>
                            <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                                <NavLink :href="route('damaged-items.index')" :active="route().current('damaged-items.index')">
                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        <span class="inline-flex rounded-md">
                                            ...
                                            >
                                                Welcome, admin {{ $page.props.auth.user.name }}!
                ...
                >
                    <div class="pt-2 pb-3 space-y-1">
                        ...
                        <ResponsiveNavLink :href="route('borrowed-items.index')" :active="route().current('borrowed-items.index')">
                            Borrowed Items
                        </ResponsiveNavLink>
                        <ResponsiveNavLink :href="route('damaged-items.index')" :active="route().current('damaged-items.index')">
                            Damaged Items
                        </ResponsiveNavLink>
                    </div>
